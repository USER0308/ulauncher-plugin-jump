...
class List_choice():
    ...
    def get_top_five(self,path):
        ...
        self.check_exist(self.database_path)
        f = open(self.database_path,'r')  # open for read
        # print f
        records = []
        for line in f:
    ...
    def write_path(self,path):
        ...
        read_file = open(self.database_path, "r")  # open for write
        ...
        for line in read_file:
            ...
            if path == record_list[0]:
                ...
                write_file.flush()
        if not new_flag:  # if it is a new record
            # check path exist
        ...
        os.rename(tmp_path,self.database_path)
